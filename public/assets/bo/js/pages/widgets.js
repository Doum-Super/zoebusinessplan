...
var KTWidgets = function() {
    ...
    var _initStatsWidget11 = function() {
        ...
        var dataCollect = $('.js-data-collect').data('collect');
        var dataCollectCategory = $('.js-data-collect-category').data('collect-category');
        ...
        var options = {
            ...
            xaxis: {
                categories: dataCollectCategory,
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    var _initStatsWidget12 = function() {
        ...
        var dataMerchantCount = $('.js-data-merchant-count').data('merchant-count');
        var dataEmissionCategory = $('.js-data-emission-category').data('emission-category');

        var options = {
            series: [{
                name: 'Marchand',
                data: dataMerchantCount
            }],
            chart: {
                type: 'area',
                height: height,
            ...
            xaxis: {
                categories: dataEmissionCategory,
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    var _initMixedWidget1 = function() {
        ...
        console.log(dataCollectCategory);
