...
class AddUserCommand extends Command
{
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if (null !== $password) {
            $this->io->text(' > <info>Password</info>: '.str_repeat('*', strlen($password)));
        } else {
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->validateUserData($plaintextPassword, $email);
        ...
        $this->io->success(sprintf('%s was successfully created: %s', 'Administrator user', $user->getEmail()));
